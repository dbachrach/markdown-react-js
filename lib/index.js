...
var _lodashFrompairs = require('lodash.frompairs');

var _lodashFrompairs2 = _interopRequireDefault(_lodashFrompairs);
...
function convertTree(tokens, convertRules, options) {
  function convertBranch(tkns, nested) {
    ...
    while (token && token.nesting !== -1) {
      var attrs = token.attrs && (0, _lodashFrompairs2['default'])((0, _lodashSortby2['default'])(token.attrs, 0));
...
function mdReactFactory() {
  ...
  function iterateTree(tree) {
    ...
    if ((0, _lodashIsstring2['default'])(props.style)) {
      props.style = (0, _lodashFrompairs2['default'])(props.style.split(';').map(function (prop) {
        return prop.split(':');
      }).map(function (keyVal) {
